...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav"> <a class="navbar-brand" href="">
		<s:property value="userInfo.Account" />
	</a>
	...
	<div class="collapse navbar-collapse" id="navbarResponsive">
		<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
			...
			<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Factory">
			...
			<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Consumer">
			...
			<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Reserve">
		...
		<ul class="navbar-nav ml-auto">
			<li class="nav-item">
				<a class="nav-link" data-toggle="modal" data-target="#exampleModal">
					<s:property value="lgView.getId('025')" />
