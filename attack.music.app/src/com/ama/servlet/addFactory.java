...
//	}
	...
	private String execute(HttpServletRequest request, HttpServletResponse response, ora.json.JSONObject reqJson, Connection conn) throws SQLException{
		...
		pstmt.setString(1, StringsUtil.isNull(reqJson.getString("FactoryId"))?"0":reqJson.getString("FactoryId"));
		pstmt.setString(2, reqJson.getString("FactoryName"));
		pstmt.setString(3, reqJson.getString("FactoryContact"));
		pstmt.setString(4, reqJson.getString("FactoryAddress"));
		pstmt.setString(5, reqJson.getString("FactoryMobile"));
		pstmt.setString(6, reqJson.getString("FactoryRemark"));
